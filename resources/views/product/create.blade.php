...
<body>
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype='multipart/form-data'
      ...
      <div class="flex-1">
        ...
        <div id="uploaded_images"
          class="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-3 sm:grid-cols-2 gap-2.5 mt-2.5">
        ...
        <div class="add_photos w-full">
          <div>
            ...
            <input name="photos[]" id="upload_input" type="file" multiple accept="image/*" required
  ...
  <script>
    ...
    function imagesCountWatch(amount) {
      if (imagesCount + amount < 10) {
        imagesCount += amount;
      }
    }
            ...
            let html = `
						<div class="photo_item relative" data-index="${uniqueID}">
							...
							<div class="photo_content absolute top-2.5 right-2.5">
								...
								<input type="checkbox" name="main_image" id="main_image" class="photo_item_btn">
								</div>
							</div>
						</div>`;
