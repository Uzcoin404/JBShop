...
<body>
  <div class="2xl:container mx-auto lg:px-10 px-4 mt-12 pb-20">
    ...
    <form action="#" class="flex lg:flex-row flex-col lg:gap-10 gap-y-12 mt-3">
      <div class="flex-1">
        <div class="w-full">
        ...
        <div class="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-3 sm:grid-cols-2 gap-2.5 mt-2.5">
          <div class="photo_item relative">
            <img src="img/image1.png" alt="" class="h-full">
              ...
              <div class="flex gap-x-1.5">
                <button type="button" class="photo_item_btn">
                  <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                    ...
                    <path
                      d="M5.90088 3.31461L6.05359 2.441C6.16465 1.80747 6.24794 1.33398 7.42101 1.33398H9.23962C10.4127 1.33398 10.5029 1.83414 10.607 2.44767L10.7597 3.31461"
                      stroke="#333333" stroke-width="0.800254" stroke-linecap="round" stroke-linejoin="round" />
                    <path
