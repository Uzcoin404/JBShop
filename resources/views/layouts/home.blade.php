...
<body>
  <header>
    <nav class="mx-auto flex max-w-screen-2xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex">
        <a href="{{ route('home') }}" class="mr-5 -m-1.5 p-1.5">
          <img class="nav__logo" src="{{ asset('img/icons/logo.png') }}" alt="">
        </a>
      </div>
      <div class="flex lg:hidden">
        <button type="button" id="navbar_menu_btn"
      ...
      <div class="hidden lg:flex xl:gap-x-12 gap-x-5">
        <p class="flex 2xl:text-lg text-sm 2xl:font-bold font-semibold nav__link">
          <img src="{{ asset('img/icons/circle-check.svg') }}" alt="" class="mr-2">
    ...
    <div class="hidden" id="navbar_toggle" role="dialog" aria-modal="true">
      ...
      <div
        class="fixed inset-y-0 right-0 z-10 w-4/5 overflow-y-auto bg-white px-6 py-6 sm:max-w-sm ring-1 ring-gray-900/10">
        <div class="flex items-center justify-between">
          <h5 class="font-bold text-lg text-gray-700">Menu</h5>
  ...
  <div class="hero">
    <div class="2xl:container mx-auto px-5">
      <div class="hero_content flex items-center flex-col md:flex-row">
        <img src="{{ asset('img/hero-mobile.png') }}" alt="" class="hero_img block md:hidden mb-8">
        ...
        <img src="{{ asset('img/hero.png') }}" alt="" class="hero_img hidden md:block">
      </div>
    </div>
  </div>
  <div class="2xl:container mx-auto px-5">
        ...
        <div class="header_box_icon">
          <svg width="43" height="32" viewBox="0 0 43 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
              d="M2.34014 0.888889C2.34014 0.397969 2.73303 0 3.21769 0H28.0816C29.2125 0 30.1293 0.928595 30.1293 2.07407V6.51852C30.1293 6.68216 30.2602 6.81482 30.4218 6.81482H35.3946C36.0391 6.81482 36.646 7.12218 37.0327 7.64444L42.5905 15.1506C42.8563 15.5096 43 15.9463 43 16.3951V23.1111C43 24.2566 42.0833 25.1852 40.9524 25.1852H3.21769C2.73303 25.1852 2.34014 24.7872 2.34014 24.2963C2.34014 23.8054 2.73303 23.4074 3.21769 23.4074H40.9524C41.1139 23.4074 41.2449 23.2748 41.2449 23.1111V16.3951C41.2449 16.331 41.2244 16.2686 41.1864 16.2173L35.6286 8.71111C35.5733 8.6365 35.4866 8.59259 35.3946 8.59259H30.4218C29.2909 8.59259 28.3741 7.664 28.3741 6.51852V2.07407C28.3741 1.91043 28.2432 1.77778 28.0816 1.77778H3.21769C2.73303 1.77778 2.34014 1.37981 2.34014 0.888889Z"
              fill="#333333" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M28.3741 24.2963V3.25926H30.1293V24.2963H28.3741Z"
              fill="#333333" />
            <path fill-rule="evenodd" clip-rule="evenodd"
              d="M2.92517 8.2963C2.92517 7.80538 3.31806 7.40741 3.80272 7.40741H16.381C16.8656 7.40741 17.2585 7.80538 17.2585 8.2963C17.2585 8.78722 16.8656 9.18519 16.381 9.18519H3.80272C3.31806 9.18519 2.92517 8.78722 2.92517 8.2963Z"
              fill="#333333" />
            <path fill-rule="evenodd" clip-rule="evenodd"
              d="M0 17.1852C0 16.6943 0.392893 16.2963 0.877551 16.2963H13.4558C13.9404 16.2963 14.3333 16.6943 14.3333 17.1852C14.3333 17.6761 13.9404 18.0741 13.4558 18.0741H0.877551C0.392893 18.0741 0 17.6761 0 17.1852Z"
              fill="#333333" />
            <path fill-rule="evenodd" clip-rule="evenodd"
              d="M7.26375 24.2963C6.88032 24.2963 6.54052 24.5612 6.48976 24.9462C6.45389 25.2182 6.43537 25.4958 6.43537 25.7778C6.43537 29.2142 9.18563 32 12.5782 32C15.9708 32 18.7211 29.2142 18.7211 25.7778C18.7211 25.4958 18.7026 25.2182 18.6667 24.9462C18.6159 24.5612 18.2761 24.2963 17.8927 24.2963C17.3186 24.2963 16.9144 24.8793 16.9549 25.4594C16.9622 25.5646 16.966 25.6707 16.966 25.7778C16.966 28.2324 15.0015 30.2222 12.5782 30.2222C10.1549 30.2222 8.19048 28.2324 8.19048 25.7778C8.19048 25.6707 8.19421 25.5646 8.20156 25.4594C8.24209 24.8793 7.83789 24.2963 7.26375 24.2963ZM26.5699 24.2963C26.1864 24.2963 25.8466 24.5612 25.7959 24.9462C25.76 25.2182 25.7415 25.4958 25.7415 25.7778C25.7415 29.2142 28.4917 32 31.8844 32C35.277 32 38.0272 29.2142 38.0272 25.7778C38.0272 25.4958 38.0087 25.2182 37.9728 24.9462C37.9221 24.5612 37.5823 24.2963 37.1988 24.2963C36.6247 24.2963 36.2205 24.8793 36.261 25.4595C36.2684 25.5646 36.2721 25.6707 36.2721 25.7778C36.2721 28.2324 34.3076 30.2222 31.8844 30.2222C29.4611 30.2222 27.4966 28.2324 27.4966 25.7778C27.4966 25.6707 27.5003 25.5646 27.5077 25.4594C27.5482 24.8793 27.144 24.2963 26.5699 24.2963Z"
              fill="#333333" />
          </svg>
        </div>
        <div class="pl-5">
      ...
      <div class="flex flex-wrap xl:gap-x-12 gap-x-8 gap-y-8">
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm leading-8">E-Mail:
              <span class="font-bold"><a href="mailto:jbcompany24@gmail.com"
                  class="underline">jbcompany24@gmail.com</a></span>
            </p>
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2" style="max-width: 400px;">
            <img src="{{ asset('img/icons/Paypal.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/visa.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/Mastercard Full.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/Klarna.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/GooglePay.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/ApplePay.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/SEPA.png') }}" alt="" class="h-max">
          </div>
        </div>
        <div>
          <p class="text-lg font-bold text-left mb-5">Versandpartner</p>
          <div class="flex flex-wrap gap-2" style="max-width: 270px;">
            <img src="{{ asset('img/icons/dhl.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/gls-logo 1.png ') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/dpd.png') }}" alt="" class="h-max">
            <img src="{{ asset('img/icons/UPS.png') }}" alt="" class="h-max">
          </div>
        </div>
      </div>
    </div>
